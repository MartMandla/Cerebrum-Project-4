...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', ()=>{
        ...
        // Change confirmation password so it matches password
        ...
        // Assert that submit button is activated
        cy.get('h2').contains('Password').click()
    ...
    it('Test to check for all mandatory fields', ()=>{
        // Add test steps for filling in ONLY mandatory fields
        ...
        // Assert that Username is mandatory
        ...
        // Assert that first name is mandatory
        cy.get('#email').type('validemail@yeap.com')
        cy.get('[data-cy="name"]').clear()
        cy.get('h2').contains('Password').click()
        cy.get('.submit_button').should('be.disabled')

        // Assert that last name is mandatory
        cy.get('[data-cy="name"]').type('John')
        cy.get('#lastName').clear()
        cy.get('h2').contains('Password').click()
        cy.get('.submit_button').should('be.disabled')

        // Assert that Phone number is mandatory
        cy.get('#lastName').type('Doe')
        cy.get('[data-testid="phoneNumberTestId"]').clear()
        cy.get('h2').contains('Password').click()
        cy.get('.submit_button').should('be.disabled')
        
        // Assert that Password is mandatory
        cy.get('[data-testid="phoneNumberTestId"]').type('10203040')
